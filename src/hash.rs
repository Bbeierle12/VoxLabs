//! SHA-256 (FIPS 180-4), dependency-free, for provenance: input files,
//! mode files and parameter sets are identified by their digest. Not a
//! performance path — a fixture is hashed once per run.
...
mod tests {
    ...
    fn known_vectors() {
        ...
        // Two blocks with the length in the second.
        assert_eq!(
